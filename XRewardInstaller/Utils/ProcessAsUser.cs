...
namespace Spareio.Installer.Utils
{
    ...
    internal static class ProcessAsUser
    {
        ...
        private const short SW_SHOWDEFAULT = 10;
        ...
        private static IntPtr GetPrimaryToken(int processId)
        {
            ...
            // retVal = WTSQueryUserToken(WTSGetActiveConsoleSessionId(), out token) == 0;
        ...
        public static int Launch(string appCmdLine /*,int processId*/)
        {
            ...
            if (processId > 1)
            {
                ...
                if (token != IntPtr.Zero)
                {
                    ...
                    ret = (int)LaunchProcessAsUser(appCmdLine, token, envBlock);
